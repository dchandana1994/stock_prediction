'''
This code is, if partial data is available then run this program. 
'''

from codes.Companies import ApiDetails,stock_time_zone,constituent_data,fetch_data
...
raw_data_json = Constants.RAW_DATA_JSON
k_value       = Constants.K
...
get_data = fetch_data()
company_details = s_p_data.get_topK_dict(k=k_value)
